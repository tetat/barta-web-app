    ...
    <main
      ...
      <form action="{{route('image.update')}}" enctype="multipart/form-data" method="POST">
        ...
        <div class="mt-6 flex items-center justify-start gap-x-6">
          <a href="{{route('me.get')}}" class="rounded-md bg-gray-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-gray-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-600">Cancel</a>
          <button
            type="submit"
