      ...
      <section
        ...
        <article
              ...
              <div class="flex items-center space-x-3">
               ...
               <div class="flex-shrink-0">
                 <img
                   ...
                   src="{{ $post->user->getFirstMediaUrl('avatar') ? asset('/storage' . explode('/storage', $post->user->getFirstMediaUrl('avatar'))[1]) : asset('images/poultry.png')}}"
                        alt="{{$post->user->name}}" />
               </div>
                <!-- /User Avatar -->
          ...
          <div class="flex items-center gap-2 text-gray-500 text-xs my-2">
            ...
            <span class="">•</span>
            <span>{{$post->comments->count('id')}} comments</span>
            <span class="">•</span>
            <span>450 views</span>
          </div>
